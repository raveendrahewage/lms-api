...
namespace LMS.Data.Migrations
{
    ...
    [Migration("20260817082047_AddedBlobNameColumn")]
    partial class AddedBlobNameColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Data.Models.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Data.Models.LeaveAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("BalanceCount")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<decimal>("BookedCount")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("LMS.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Data.Models.SystemRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 8, 17, 8, 20, 46, 583, DateTimeKind.Utc).AddTicks(8443),
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "initial",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 8, 17, 8, 20, 46, 584, DateTimeKind.Utc).AddTicks(1141),
                            Name = "User",
                            NormalizedName = "USER",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("LMS.Data.Models.SystemUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "initial",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 8, 17, 8, 20, 46, 589, DateTimeKind.Utc).AddTicks(6633),
            ...
            modelBuilder.Entity("LMS.Data.Models.File", b =>
                {
                    b.HasOne("LMS.Data.Models.SystemUser", "UploadedBy")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("LMS.Data.Models.LeaveAvailability", b =>
                {
                    b.HasOne("LMS.Data.Models.LeaveType", "LeaveType")
                        .WithMany("LeaveAvailabilities")
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("LMS.Data.Models.SystemUser", "SystemUser")
                        .WithMany("LeaveAvailabilities")
            ...
            modelBuilder.Entity("LMS.Data.Models.Notification", b =>
                {
                    b.HasOne("LMS.Data.Models.SystemUser", "User")
            ...
            modelBuilder.Entity("LMS.Data.Models.LeaveType", b =>
                {
                    b.Navigation("LeaveAvailabilities");
